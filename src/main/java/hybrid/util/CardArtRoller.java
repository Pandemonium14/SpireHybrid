...
import hybrid.cards.AbstractEasyCard;
...
public class CardArtRoller {
    private static final Texture attackMask = TexLoader.getTexture(HybridMod.makeImagePath("masks/AttackMask.png"));
    private static final Texture skillMask = TexLoader.getTexture(HybridMod.makeImagePath("masks/SkillMask.png"));
    private static final Texture powerMask = TexLoader.getTexture(HybridMod.makeImagePath("masks/PowerMask.png"));
