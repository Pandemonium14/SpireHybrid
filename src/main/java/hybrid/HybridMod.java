...
import hybrid.cards.cardvars.AbstractEasyDynamicVariable;
import hybrid.relics.AbstractEasyRelic;
import hybrid.util.ProAudio;
import java.nio.charset.StandardCharsets;

@SuppressWarnings({"unused", "WeakerAccess"})
@SpireInitializer
public class HybridMod implements
        EditCardsSubscriber,
    ...
    public static void initialize() {
        HybridMod thismod = new HybridMod();
    }
